...
public final class SupplyCashAsyncTask<A extends Activity & SupplyCashAsyncTask.Listener> extends AsyncTask<Object, Void, Object> {


    private WeakReference<A> activity;


    public SupplyCashAsyncTask(A activity) {
    ...
    protected void onPostExecute(Object callResult) {
        ...
        if (listener != null) {
            ...
            if (callResult instanceof CashModel) {
                ...
                listener.onSupplyCashSuccess((CashModel) callResult);

            } else {

                if (callResult instanceof Messaging) {

                    listener.onSupplyCashFailure((Messaging) callResult);
    ...
    public interface Listener {
        ...
        void onSupplyCashSuccess(CashModel cashModel);

        void onSupplyCashFailure(Messaging messaging);
