...
public final class UpdateCatalogItemAsyncTask<A extends Activity & UpdateCatalogItemAsyncTask.Listener> extends AsyncTask<CatalogItemModel, Void, Object> {


    private WeakReference<A> activity;


    public UpdateCatalogItemAsyncTask(A activity) {
    ...
    protected Object doInBackground(CatalogItemModel... parameters) {
        ...
        try {
            ...
            catalogItemVO.setQuantity(catalogItemModel.getQuantity());
    ...
    protected void onPostExecute(Object callResult) {
        ...
        if (listener != null)
            ...
            if (callResult instanceof Messaging)
                ...
                listener.onUpdateCatalogItemFailure((Messaging) callResult);
    ...
    public interface Listener {
        ...
        void onUpdateCatalogItemFailure(Messaging messaging);
