...
public class Hashids {
    ...
    private static final String DEFAULT_ALPHABET = "1234567890";
    ...
    private static final int MIN_ALPHABET_LENGTH = 10;
    ...
    public Long encode(long... numbers) {
        ...
        return Long.valueOf(this._encode(numbers));
    ...
    private Long _encode(long... numbers) {
